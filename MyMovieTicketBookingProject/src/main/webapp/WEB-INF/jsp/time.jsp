	...
	<div class="container-fluid">
		<div class="row">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<h4 class="ml-5 ">Add Show time</h4>
				<div>
					<div class="container ml-5">
							...
							<div class="col-sm-8 col-md-5">
								...
								<form action="/saveTime" method="post">
									...
									<div class="form-group">
										...
										<label>Show name</label> <input type="text" name="showName"
											class="form-control" required="required"
											autofocus="autofocus">
						...
						<div>
							<table class="table table-striped table-bordered mt-2">
								...
								<tbody>
									<c:forEach items="${time}" var="t" varStatus="count">
										...
										<tr class="text-center">
											...
											<td> 
											<a href="../delete/time/${t.id }" class="btn btn-danger badge" onclick="return confirm('are you sure')">Delete</a>
