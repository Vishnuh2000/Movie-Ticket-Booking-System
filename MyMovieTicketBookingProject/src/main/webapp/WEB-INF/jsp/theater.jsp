					         ...
					         <form action="/saveTheater" method="post">
					              ...
					              <div class="form-group">
					               ...
					               <div class="form-group">
					                 ...
					                 <label>Screen</label>
					                 <input type="text" name="screen" class="form-control" required="required" autofocus="autofocus">
					               ...
					               <div class="form-group">
					                 ...
					                 <label>Contact</label>
					                 <input type="tel" name="contact" class="form-control" required="required" autofocus="autofocus">
					               ...
					               <div class="form-group">
					                 ...
					                 <input type="text" name="district"  class="form-control" required="required" autofocus="autofocus">
					              
					              </div>
					               <div class="form-group">
					              
					                 <label>city</label>
					                 <input type="text" name="city" class="form-control" required="required" autofocus="autofocus">
					               ...
					               <div class="form-group">
					                 ...
					                 <label>Address</label>
					                 <textarea rows="" cols="" name="address" class="form-control"></textarea>
