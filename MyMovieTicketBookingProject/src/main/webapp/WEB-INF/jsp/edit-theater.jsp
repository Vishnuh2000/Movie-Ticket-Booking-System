					       ...
					       <div class="col-sm-8 col-md-5">
					         ...
					         <form action="../updateTheater" method="post">
					              ...
					              <div class="form-group">
					                 ...
					                 <label>Name</label>
					                 <input type="text" name="name" class="form-control" value="${theater.name}">
					               ...
					               <div class="form-group">
					                 ...
					                 <label>Screen</label>
					                 <input type="text" name="screen" class="form-control" value="${theater.screen}">
					               ...
					               <div class="form-group">
					                 ...
					                 <label>Contact</label>
					                 <input type="tel" name="contact" class="form-control" value="${theater.contact}">
					               ...
					               <div class="form-group">
					                 ...
					                 <input type="text" name="district"  class="form-control" value="${theater.district}">
					              
					              </div>
					               <div class="form-group">
					              
					                 <label>city</label>
					                 <input type="text" name="city" class="form-control" value="${theater.city}">
					               ...
					               <div class="form-group">
					                 ...
					                 <label>Address</label>
					                 <textarea rows="" cols="" name="address" class="form-control" >${theater.name}</textarea>
					               ...
					               <div class="form-group">
					                 ...
					                 <label>Show Time</label>
					                  <input type="time" value="${theater.name}" class="form-control" name="showTime">
