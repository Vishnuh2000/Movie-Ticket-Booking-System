								...
								<form action="/updateMovie" method="post"
									...
									<div class="form-group">
										...
										<label>Movie Name</label> <input type="text" name="movie_name"
											...
											autofocus="autofocus" value="${movie.movie_name }">
									...
									<div class="form-group">
										...
										<label>Director</label> <input type="text" name="director"
											class="form-control" required="required"
											autofocus="autofocus" value="${movie.director }">
									...
									<div class="form-group">
										...
										<label>Cast</label> <input type="text" name="cast"
											class="form-control" required="required"
											autofocus="autofocus" value="${movie.cast }">
									...
									<div class="form-group">
										...
										<label>Link</label> <input type="text" name="video"
											class="form-control" required="required"
											autofocus="autofocus" value="${movie.video }">
									...
									<div class="form-group">
										...
										<label>Image</label> <input type="file" name="file"
											accept="jpg" class="form-control" value="data:image/jpg;base64,${movie.image}" required="required">
									...
									<div class="form-group">
										...
										<label>Start date</label> <input type="date" name="start_date"
											 class="form-control" required="required" value="${movie.start_date }">
									...
									<div class="form-group">
										...
										<label>End Date</label> <input type="date" name="end_date"
											 class="form-control" required="required" value="${movie.end_date }">
